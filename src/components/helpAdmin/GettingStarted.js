                    ...
                    <div className="card card-body" 
                        ...
                        <ol style={{paddingLeft:"10px"}}>
                            <li>
                                ...
                                <img alt='' id="SignUp1" src={require("./SignUp1.JPG")} ></img>
                            </li>
                            <li>
                                Click on "Sign Me Up!" button. You will receive verification link on your webmail account.<br/>
                                <img alt='' id="SignUp2" src={require("./SignUp2.JPG")} ></img>
                            </li>                                
                            <li>
                                Click on the verification link and you are good to go.
                                <img alt='' id="SignUp3" src={require("./SignUp3.JPG")} style={{marginTop:"15px", marginBottom:"15px"}}></img>
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div className="collapse" id = "collapseExample2">
                    <div className="card card-body" 
                        ...
                        <ol style={{paddingLeft:"10px"}}>
                            <li>
                                Enter User Name and Password in respective fields.<br/>
                                <img alt='' id="LogIn1" src={require("./LogIn1.JPG")} ></img>
                            </li>
                            <li>
                    ...
                    <div className="card card-body" 
                        ...
                        <ol style={{paddingLeft:"10px"}}>
                            <li>
                                ...
                                <br/>
                                <img alt='' src={require("./Home1.JPG")} style={{width:"100%",marginTop:"15px", marginBottom:"15px"}}></img>
                                <img alt='' src={require("./Home2.JPG")} style={{width:"100%",marginTop:"15px", marginBottom:"15px"}}></img>
                            </li>       
                        </ol>
                    </div>
                </div>                
